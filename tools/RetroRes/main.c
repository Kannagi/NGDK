...
void init(COMMAND *command,int os)
{
	if(os == 0)
	{
		strcpy(command->pathRetroConvert,"/usr/local/SDK/tools/RetroConvert");
		strcpy(command->pathRomK,"/usr/local/SDK/tools/RomK");
		strcpy(command->pathBin2c,"/usr/local/SDK/tools/bin2c");
		strcpy(command->pathNGextract,"/usr/local/SDK/tools/neogeoextract");
		strcpy(command->pathRetroTMX,"/usr/local/SDK/tools/RetroTMX");
	}else
	{
		strcpy(command->pathRetroConvert,"c:\\SDK\\tools\\RetroConvert.exe");
		strcpy(command->pathRomK,"c:\\SDK\\tools\\RomK.exe");
		strcpy(command->pathBin2c,"c:\\SDK\\tools\\bin2c.exe");
		strcpy(command->pathNGextract,"c:\\SDK\tools\\neogeoextract.exe");
		strcpy(command->pathRetroTMX,"c:\\SDK\\tools\\RetroTMX.exe");
	}
