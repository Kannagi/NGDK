...
void __attribute__((noinline)) NG_Prints16(s16 val,u16 x,u16 y)
{
	NG_arg1_u16 = x;
	NG_arg2_u16 = y;
	NG_arg3_u16 = val;
...
void __attribute__((noinline)) NG_Printu16(u16 val,u16 x,u16 y)
{
	NG_arg1_u16 = x;
	NG_arg2_u16 = y;
	NG_arg3_u16 = val;
...
void __attribute__((noinline)) NG_Printh16(u16 val,u16 x,u16 y)
{
	NG_arg1_u16 = x;
	NG_arg2_u16 = y;
	NG_arg3_u16 = val;
